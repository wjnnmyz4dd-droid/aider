...
from titan_protocol.validation_engine.monte_carlo_validation import run_monte_carlo_validation
from tests.titan_protocol.validation_engine._fixtures import make_config, make_repeating_executed_trades, make_trade_history
...
class TestMonteCarloValidation(unittest.TestCase):
    ...
    def test_excludes_rejected_trades(self):
        from tests.titan_protocol.validation_engine._fixtures import make_rejected_trade
