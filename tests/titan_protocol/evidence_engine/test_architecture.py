...
vocabulary, no import from `phantom_pipeline/` or `titan_protocol/bridge/`, no
randomness, in any `titan_protocol/evidence_engine/` source file."""
...
PACKAGE_ROOT = Path(__file__).resolve().parents[3] / "titan_protocol" / "evidence_engine"
