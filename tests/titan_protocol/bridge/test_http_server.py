"""Full-stack HTTP tests for the TitanProtocolEA server (Phase 1) --
...
from titan_protocol.bridge.server import API_KEY_HEADER, registered_routes, serve
from tests.titan_protocol.bridge._fixtures import API_KEY, make_command, make_config
