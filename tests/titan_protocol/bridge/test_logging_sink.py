...
from titan_protocol.bridge.logging_sink import log_emergency_stop, log_error_report
from titan_protocol.bridge.models import EmergencyStopState, ErrorReport, SCHEMA_VERSION
from tests.titan_protocol.bridge._fixtures import T0
...
class LoggingSinkTestCase(unittest.TestCase):
    def setUp(self):
        self.logger = logging.getLogger("titan_protocol.bridge")
