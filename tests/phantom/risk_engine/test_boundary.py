...
from phantom.risk_engine.confidence import confidence_tier_for_evidence_score
from phantom.risk_engine.engine import RiskEngine
from phantom.risk_engine.gate import check_evidence_gate
from phantom.risk_engine.models import RejectionReason
from phantom.risk_engine.position_sizing import compute_position_size
...
class TestZeroRiskCandidate(unittest.TestCase):
    def test_zero_confidence_base_r_produces_zero_or_floor_final_r(self):
        from phantom.risk_engine.models import ConfidenceTier, StatisticalMetrics, VolatilityAdjustment
