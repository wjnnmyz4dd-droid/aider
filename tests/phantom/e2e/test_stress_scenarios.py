...
multi-pair stress suite (`tests/phantom/runtime/test_stress.py`) or
Phase 3B's own recovery suite (`tests/phantom/e2e/test_recovery.py`,
...
from tests.phantom.compliance_engine._fixtures import make_account_state, make_risk_snapshot, make_strategy_snapshot
from tests.phantom.e2e._fixtures import make_config, make_profile, make_stub_bridge_submit, make_stub_compliance_engine, make_stub_evidence_engine, make_stub_mi_engine, make_stub_risk_engine, make_stub_strategy_engine
