...
from phantom.compliance_engine.models import ComplianceDecision, ComplianceRuleId, ComplianceRuleProfile
...
class TestProfileThresholdsTakeEffect(unittest.TestCase):
    ...
    def test_narrower_approved_sessions_from_profile_enforced(self):
        ...
        from phantom.evidence_engine.models import SessionState
