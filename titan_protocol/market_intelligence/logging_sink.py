...
return value -- same discipline as `titan_protocol/bridge/logging_sink.py` and
`titan_protocol/evidence_engine/logging_sink.py`.
"""
...
logger = logging.getLogger("titan_protocol.market_intelligence")
