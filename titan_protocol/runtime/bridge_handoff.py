...
`titan_protocol.bridge.validation.check_stop_loss_take_profit` already accepts
`None` for both."""
...
from titan_protocol.bridge.models import CommandKind, TradeCommand
from titan_protocol.bridge.models import SCHEMA_VERSION as BRIDGE_SCHEMA_VERSION
