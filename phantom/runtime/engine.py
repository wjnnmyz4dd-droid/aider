...
from phantom.bridge.models import ErrorCode, TradeCommand
from phantom.compliance_engine.engine import ComplianceEngine
from phantom.compliance_engine.models import AccountState, ComplianceDecision
...
from phantom.market_intelligence.models import MarketSafetyInputs, NewsEvent
from phantom.risk_engine.engine import RiskEngine
from phantom.risk_engine.models import PortfolioState, TradeHistory
from phantom.strategy_engine.engine import StrategyEngine
from phantom.strategy_engine.models import TradeIntent
...
def _engine_versions() -> Tuple[Tuple[str, str], ...]:
    from phantom.compliance_engine.config import COMPLIANCE_ENGINE_VERSION
    from phantom.evidence_engine.config import EVIDENCE_ENGINE_VERSION
    from phantom.market_intelligence.config import MARKET_INTELLIGENCE_ENGINE_VERSION
    from phantom.risk_engine.config import RISK_ENGINE_VERSION
    from phantom.strategy_engine.config import STRATEGY_ENGINE_VERSION
