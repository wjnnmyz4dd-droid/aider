...
class MarketResearchAgent:
    ...
    def build_finding(self, symbol: str, observation: ScannerObservation) -> MarketStructureFinding:
    ...
    def generate_report(
        ...
        findings = tuple(self.build_finding(symbol, observation) for symbol, observation in observations)
        active_currencies = ()
    ...
    def generate_daily(
        ...
        return self.generate_report(report_id, "DAILY", window_start, now, now, observations, news_state)
    ...
    def generate_weekly(
        ...
        return self.generate_report(report_id, "WEEKLY", window_start, now, now, observations, news_state)
