...
class ReasonCode:
    ...
    # M6: a RELEVANT, in-window event whose impact cannot be established as a known
    # value — fail closed (never silently treated as harmless/low).
    NEWS_IMPACT_UNKNOWN = "NEWS_IMPACT_UNKNOWN"
    # -- broker health --------------------------------------------------------
