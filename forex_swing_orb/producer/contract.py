...
class CycleOutcome:
    ...
    UNIT_ERROR = "UNIT_ERROR"                        # M3: isolated symbol/session fault
...
class RunnerReason:
    ...
    ACCOUNT_FUTURE = "R_ACCOUNT_FUTURE"                           # M8: as_of ahead of now (clock rollback / fabricated)
    ACCOUNT_ANCHOR_UNAVAILABLE = "R_ACCOUNT_ANCHOR_UNAVAILABLE"   # P3A-1 mid-day cold start
    FRIDAY_NO_NEW_ENTRY = "R_FRIDAY_NO_NEW_ENTRY"                 # M12: per-session Friday no-new-entry cutoff
    ...
    UNIT_ERROR = "R_UNIT_ERROR"                      # M3: isolated symbol/session fault
    ...
    REQUIRED = frozenset({
        ...
        ACCOUNT_UNAVAILABLE, ACCOUNT_STALE, ACCOUNT_FUTURE, ACCOUNT_ANCHOR_UNAVAILABLE,
        FRIDAY_NO_NEW_ENTRY, NO_CANDIDATE,
